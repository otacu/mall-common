package com.egoist.mall.parent.pojo;
...
public class EgoistResult implements Serializable {
     ...
     * OK状态码：200
     */
    private static final int OK_STATUS = EgoistResultStatusConstant.STATUS_200;
     ...
     * @param msg    提示信息
     */
    public EgoistResult(Integer status, String msg) {
        this.status = status;
        this.msg = msg;
        this.data = null;
    }
